...
namespace BadaoKingdom.BadaoChampion.BadaoJhin
{
    public static class BadaoJhinConfig
    {
        ...
        public static void BadaoActivate()
        {
            ...
            BadaoJhinVariables.AutoRMode = Auto.AddItem(new MenuItem("AutoRMode", "R mode")).SetValue(new StringList(new [] {"Auto","OnTap" }, 0));
            BadaoJhinVariables.AutoRTarget = Auto.AddItem(new MenuItem("AutoREnemies", "R target")).SetValue(new StringList(new[] { "Selected", "Near Mouse", "Auto" }, 2));
